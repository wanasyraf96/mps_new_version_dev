...
function Register(props) {
  ...
  const handleRegister = (e) => {
    ...
    .then(response => {
      ...
      console.log('No Kp:'+formData.get('nokp'));
    })
  };
                ...
                <div className="px-4 py-5 bg-white sm:p-6">
                  <div className="grid grid-cols-6 gap-6">
                    ...
                    <div className="col-span-6">
                      ...
                      <input id="nokp" onChange={(e) => handleChange(e)} className="mt-1 form-input block w-full py-2 px-3 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:shadow-outline-blue focus:border-blue-300 transition duration-150 ease-in-out sm:text-sm sm:leading-5" />
                    </div>
